...
//   const limit = 10; // Số bài tập mỗi trang

//   try {
//     // Gọi API để lấy bài tập
//     const options = {
//       method: "GET",
...
//       },
//       params: {
//         limit: 1400, // Lấy tối đa 1400 bài tập
//       },
//     };
...
//     // Lấy tổng số bài tập và số trang
...
//           },
//         },
//         skip: (page - 1) * limit, // Bỏ qua các bài tập của các trang trước đó
//         take: limit, // Lấy số bài tập giới hạn
//       });
//     } else {
//       exercises = await prisma.exercise.findMany({
//         skip: (page - 1) * limit,
...
<div>
  <h2>Chọn bài tập cho kế hoạch của bạn</h2>

  {/* Chọn nguồn bài tập */}
  <div>
    <button onClick={() => setSelectedSource("all")}>Tất cả các bài tập</button>
    <button onClick={() => setSelectedSource("recommended")}>
  ...
  {/* Thiết lập chi tiết cho từng bài tập đã chọn */}
  <div>
    <h3>Thiết lập chi tiết bài tập</h3>
  ...
  <Form method="post" action="/Workoutplanapi">
    <input
      type="hidden"
      name="selectedExercises"
      value={JSON.stringify(selectedExercises)} // Chuyển dữ liệu bài tập đã chọn thành JSON để gửi
    />
