...
\vspace{2.05cm}
\textbf{NGUYỄN THỊ THU PHƯƠNG}

\vspace{2.15cm}
\begin{spacing}{1.16}
\textbf{\fontsize{17.5pt}{22pt}\selectfont XÂY DỰNG WEBSITE TẬP LUYỆN CÁ NHÂN HÓA\\DỰA TRÊN THỂ TRẠNG VÀ TÍCH HỢP\\TRỢ LÝ ẢO THÔNG MINH.}
\end{spacing}
